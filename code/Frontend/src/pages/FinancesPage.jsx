...
const emptyEntry = () => ({ type: 'EXPENSE', category: '', amount: '', entry_date: localDate(), project_id: '', notes: '', currency: 'THB' })
...
function FinancesPage() {
  ...
  const [filters, setFilters] = useState({ type: 'ALL', project: 'ALL', from: '', to: '' })
    ...
    <div className="page-view">
      ...
      <section className="panel">
        ...
        <div className="entry-filters finance-filters">
          <select value={filters.type} onChange={(event) => setFilters((current) => ({ ...current, type: event.target.value }))}><option value="ALL">ทุกประเภท</option><option value="INCOME">รายได้</option><option value="EXPENSE">ค่าใช้จ่าย</option></select>
