...
import type { BillingFilter, ProjectDraft, ProjectFilter, ProjectSort } from '../../../types/projectsPage'
  ...
  return (
    <div className="page-view">
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)} title={form.id ? 'แก้ไขโปรเจกต์' : 'เพิ่มโปรเจกต์'} size="large">
        <ProjectForm value={form} clients={data.clients} error={formError} saving={saving} onChange={handleChange} onSubmit={handleSubmit} onCancel={() => setModalOpen(false)} />
      </Modal>
    </div>
  )
}
